...
export const SURVEY_QUESTIONS: SurveyQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'energy_focus', label: 'All-Day High Energy & End Brain Fog', sublabel: 'No 3 PM crash, sharp focus', icon: '⚡' },
      { id: 'deep_sleep', label: 'Deep Restorative Sleep', sublabel: 'Fall asleep fast, stop waking at 3 AM', icon: '🌙' },
      { id: 'gut_healing', label: 'Heal My Gut & Stop Bloating', sublabel: 'End acid reflux, stomach pain, IBS', icon: '🥗' },
      { id: 'stress_relief', label: 'Relieve Stress, Anxiety & Burnout', sublabel: 'Calm my mind, feel peaceful', icon: '🧘' },
      { id: 'heart_health', label: 'Lower Blood Pressure & Heart Defense', sublabel: 'Clean arteries, protect heart', icon: '❤️' },
      { id: 'blood_sugar_reversal', label: 'Reverse Pre-Diabetes & High Blood Sugar', sublabel: 'Stop insulin resistance', icon: '🩸' },
      { id: 'hormone_balance', label: 'Hormone Balance & Women\'s Health', sublabel: 'PCOS, periods, perimenopause', icon: '🌸' },
      { id: 'clear_skin', label: 'Clear Glowing Skin & Anti-Aging Hair', sublabel: 'End acne, hair thinning', icon: '✨' },
      { id: 'longevity', label: 'Live Longer with Peak Health (Longevity)', sublabel: 'Stay biologically 30 at 60', icon: '🧬' },
