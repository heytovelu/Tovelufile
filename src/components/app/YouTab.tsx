  ...
  return (
    <div className="w-full space-y-4 px-4 pt-3 pb-8 animate-fadeIn">
      ...
      <div className="flex items-center justify-between py-1">
        ...
        <span className="text-[10px] uppercase font-bold px-2 py-0.5 rounded-full bg-[#00FF9D]/10 text-[#00FF9D] border border-[#00FF9D]/30 font-mono">
          SOVEREIGN HEALTH OS
        </span>
      </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h2 className="text-base font-black tracking-tight text-white">Ajay</h2>
      ...
      <div className="flex items-center gap-1.5 p-1 overflow-x-auto no-scrollbar rounded-2xl bg-slate-900/60 border border-slate-800">
        {navItems.map((item) => (
          <button
            key={item.id}
