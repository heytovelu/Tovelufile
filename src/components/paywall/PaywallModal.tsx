  ...
  const tiers = [
    {
      ...
      name: 'Monthly Reset',
      duration: 'Charged Monthly • Cancel Anytime',
      priceUSD: '$49/mo',
      priceINR: '₹1,499/mo',
      guarantee: 'Upgrade or cancel anytime',
      badge: '🔄 MONTHLY SUBSCRIPTION',
      description: 'Acute reset to reverse gut bloating and stabilize glucose spikes. Recurring charge every month.',
    },
    {
      id: 'master_90' as PricingTierId,
      name: '90-Day Master Arc',
      duration: 'Charged Every 3 Months',
      priceUSD: '$119/3-mo',
      priceINR: '₹3,499/3-mo',
      guarantee: 'Upgrade or cancel anytime',
      badge: '⭐ MOST POPULAR • QUARTERLY',
      description: 'Complete biological transformation. Deep visceral fat and cellular homeostasis. Recurring every 3 months.',
      isHero: true,
    },
    {
      id: 'annual_365' as PricingTierId,
      name: '365-Day Serious',
      duration: 'Charged Annually • Save 50%',
      priceUSD: '$299/yr',
      priceINR: '₹7,999/yr',
      guarantee: 'Upgrade or cancel anytime',
      badge: '👑 BEST VALUE • ANNUAL',
      description: 'Permanent metabolic mastery. Includes quarterly lab audit adaptations. Recurring every 12 months.',
    },
    {
      id: 'lifetime_vip' as PricingTierId,
      name: 'Lifetime VIP Access',
      duration: 'One-Time Payment • Forever Access',
      priceUSD: '$799 (One-Time)',
      priceINR: '₹19,999 (One-Time)',
      guarantee: '30-Day Money-Back Guarantee',
      badge: '💎 PRESTIGE LIFETIME (PAY ONCE)',
      description: 'Zero recurring fees. Unrestricted lifetime access to all future protocols, organ mirrors, and AI adaptations.',
    },
  ];
